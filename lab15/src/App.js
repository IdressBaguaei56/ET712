...
function App() {
  // set up an intial counter for the slice 
  // let counter = 1
  // set up state 
  ...
  //  functions to open a 'read more' paragraph
  ...
  return (
    <>
    <h1 className='title'> Slide App By Idress Baguaei </h1>
    ...
    <div className='info'>
      <p><b> Cat (Felis catus)</b>, commonly refeered to as the domestic cat or house cat</p>
